      ...
      <div className="relative h-96 w-full">
        ...
        <div className="absolute bottom-0 left-0 right-0 p-6 md:p-12">
          <div className="max-w-6xl mx-auto flex items-end gap-6">
            {vendor.logo && (
              <div className="relative w-32 h-32 rounded-full bg-white p-2 shadow-xl">
                <Image src={vendor.logo} alt={vendor.companyName} fill className="rounded-full object-cover" />
              </div>
            )}
      ...
      <div className="max-w-6xl mx-auto px-4 md:px-12 py-8 space-y-8">
        ...
        {vendor.about && (
          <Card className="p-6">
            ...
            <p className="text-gray-700 whitespace-pre-wrap">{vendor.about}</p>
          </Card>
        )}
        ...
        {vendor.reviewCount > 0 && (
          <Card className="p-6">
            ...
            <div className="flex items-center gap-2">
              ...
              <div>
                <div className="text-yellow-500 text-2xl">{'★'.repeat(Math.round(vendor.avgRating))}</div>
